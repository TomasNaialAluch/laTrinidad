...
- Acompañado del isologo (`assets/logos/logoisobandera.png` o `logofondoblacno.png`).

### 3. Galería completa de fotos del local

- Todas las fotos de [assets/store/](assets/store/) (`1.jpeg` a `18.jpeg`), en grilla o carrusel navegable.
