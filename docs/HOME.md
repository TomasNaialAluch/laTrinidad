...
- Logo `src/assets/logos/logosinfondo.png` (fondo transparente, así se apoya bien sobre el celeste del header).
...
- Carrusel a todo el ancho, autoplay, que va mostrando las fotos de [src/assets/products/](../src/assets/products/) una por una (o de a 2-3 en desktop).
...
- Acompañado del isologo (`src/assets/logos/logoisobandera.png` o `logofondoblacno.png`) al costado del texto.
...
- Arriba: unos pocos **clientes destacados** a modo de muestra (tarjetas con foto/logo del cliente, nombre y categoría — datos en `src/data/clients/`, ver [README.md](../README.md#clientes)). No se listan todos acá, solo 3-4 para dar el pantallazo.
...
- Grilla o mini-carrusel con una **muestra** de las fotos de [src/assets/store/](../src/assets/store/) (unas 4-6, no las 18).
