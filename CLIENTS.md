...
Acá va el contenido central de la página, generado a partir de los JSON en `data/clients/` (uno por rubro: `restaurants.json`, `butchers.json`, y los que se vayan sumando).
...
- [ ] Sumar más categorías de clientes a `data/clients/` (geriátricos, salones de eventos, cocinas de catering, supermercados) a medida que haya info real.
